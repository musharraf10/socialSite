  ...
  try {
    const message = {
      ...
      html: `
          ...
          <p><a href="https://skillupbuildup.netlify.app/article/${postId}" target="_blank">View Comment</a></p>
        `,
    };
  ...
  try {
    const message = {
      ...
      html: `
          ...
          <p><a href="https://skillupbuildup.netlify.app/posts/article/${postId}" target="_blank">View Article</a></p>
        `,
    };
